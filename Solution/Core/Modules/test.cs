...
namespace Core.Modules 
{
    ...
    public static class Query 
    {
        ...
        {
            MYsql my = new MYsql();
            string sql = string.Format("INSERT into Notice(mNo,nTitle,nContents)VALUES(10,'{0}','{1}')", test.nTitle, test.nContents);
            if(my.NonQuery(sql)){
                return GetSelect();
            }
            else
        ...
        {
            MYsql my = new MYsql();
            string sql = "SELECT mNo From Member WHERE mName LIKE '%최영진%';";
